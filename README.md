...
6. RSA ... Implementation of RSA algorithm to encode and decode a message. First a large prime number is generated between 1000-10,000. The number added to a large number (10^5) then acts as a seed to find large prime number. After linear search from that number to
